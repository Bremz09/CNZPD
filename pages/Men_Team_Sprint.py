...
df_splits["Marker"] = ["125m","250m","375m","500m","625m","750m"]
...
df_worm["Marker"] = ["125m","250m","375m","500m","625m","750m"]
for i in range(len(df_an)):
    var = str(df_an["Country"].iloc[i])
...
fig_event = px.line(df_an, y=[125,250,375,500,625,750], x = "Country", title="Pretty useless????", markers=True)
